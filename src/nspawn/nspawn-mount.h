...
int mount_all(const char *dest, MountSettingsMask mount_settings, uid_t uid_shift);
int mount_sysfs(const char *dest, MountSettingsMask mount_settings);

int mount_custom(const char *dest, CustomMount *mounts, size_t n, uid_t uid_shift, uid_t uid_range, MountSettingsMask mount_settings);
bool has_custom_root_mount(const CustomMount *mounts, size_t n);

int setup_volatile_mode(const char *directory, VolatileMode mode, uid_t uid_shift);
...
int tmpfs_patch_options(const char *options, uid_t uid_shift, char **ret);
